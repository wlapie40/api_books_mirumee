from books.models import Author, Books, Rates
from django.test import TestCase


class AuthorTest(TestCase):
    def setUp(self):
        Author.objects.create(author="Sandipan Dey", id="f40f097a-36fc-47b8-bcea-5f3f25a919df")
        Author.objects.create(author="Eric van Rees", id="74999557-0632-41ea-90e9-fa29c6f3e2bf")

    def test_author_creation(self):
        author_1 = Author.objects.get(author="Sandipan Dey")
        author_2 = Author.objects.get(author="Eric van Rees")
...
class BooksTest(TestCase):
    def setUp(self):
        author_1 = Author.objects.create(author="Sandipan Dey", id="f40f097a-36fc-47b8-bcea-5f3f25a919df")
